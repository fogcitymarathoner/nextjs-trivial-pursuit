...
// Create typed mock implementations so TypeScript does not infer `never`.
...
const mockFetch = jest.fn() as unknown as jest.MockedFunction<(opts: any) => Promise<{ records: Record<string, any> }>>;
